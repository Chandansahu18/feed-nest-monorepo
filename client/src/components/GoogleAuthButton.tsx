...
const GoogleAuthButton: React.FC = () => {
  ...
  const handleGoogleAuth = async () => {
    try {
      // Make request to your OAuth endpoint
      ...
      // The server should respond with a redirect (302)
      // The browser will automatically follow the redirect to Google's auth page
      // After Google auth, it will redirect back to your callback URL
    } catch (error) {
