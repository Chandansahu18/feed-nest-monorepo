...
-- AddForeignKey
ALTER TABLE "PostComment" ADD CONSTRAINT "PostComment_commentorId_fkey" FOREIGN KEY ("commentorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CommentReply" ADD CONSTRAINT "CommentReply_postCommentId_fkey" FOREIGN KEY ("postCommentId") REFERENCES "PostComment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CommentReply" ADD CONSTRAINT "CommentReply_replierId_fkey" FOREIGN KEY ("replierId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
